...
class QrScanner {
  ...
  _scanFrame() {
    ...
    requestAnimationFrame(() => {
      QrScanner.scanImage(this.$video, this._sourceRect, this._qrWorker, this.$canvas, true).then(this._onDecode, error => {
...
export { qrScanner as $qrScanner, QrScanner as $qrScannerDefault };