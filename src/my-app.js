...
document.head.appendChild($_documentContainer.content); // preventable, allowing for better scrolling performance.
...
class MyApp extends PolymerElement {
  ...
  ready() {
    ...
    fetch('./assets/questions-html.json').then(function (response) {
      return response.json();
    }).then(function (response) {
  ...
  _pageChanged(page) {
    ...
    switch (page) {
      case 'scanner':
        import('./scanner.js').then(bundle => bundle && bundle.$scanner || {});
        break;

      case 'solution':
        import('./solution.js').then(bundle => bundle && bundle.$solution || {});
        break;

      case 'question':
        import('./question.js').then(bundle => bundle && bundle.$question || {});
        break;

      case 'nexthint':
        import('./nexthint.js').then(bundle => bundle && bundle.$nexthint || {});
        break;
...
$_documentContainer$1.innerHTML = `<dom-module id="shared-styles">
  <template>
    <style>
      .card {
